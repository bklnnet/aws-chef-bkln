...
CHEF_SERVER_NAME="aws-chef-bkln" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="aws-chef-bkln-zbntwmz4uhc3h9xy.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
